...
(function (factory) {
  ...
  $.fn.arrangeable = function (options) {
    ...
    this.each(function () {
      ...
      if (dragSelector) {
        $this.on(
          dragEvents.START + eventNamespace,
          dragSelector,
          dragStartHandler
        );
      } else {
    ...
    function dragMoveHandler(e) {
      ...
      var dragDistanceX =
        (e.clientX || e.originalEvent.touches[0].clientX) - originalClientX;
      var dragDistanceY =
        (e.clientY || e.originalEvent.touches[0].clientY) - originalClientY;
    ...
    function dragEndHandler(e) {
      if (dragging) {
        ...
        //结束时触发
        // console.log(dragEndEvent.length);
        dragEndEvent.forEach(element => {
          element();
        });
        // updateaftersort();
      }
